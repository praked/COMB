...
#define GPIO_MOTOR_Z_STEP        5
#define GPIO_MOTOR_Z_DIR         18

#define GPIO_HOME_SWITCH_X_MIN   34
#define GPIO_HOME_SWITCH_X_MAX   15 

#define GPIO_HOME_SWITCH_Z_MIN   39 
#define GPIO_HOME_SWITCH_Z_MAX   13     

  #define GPIO_WING_IN1          32
  #define GPIO_WING_IN2        33

const int Motor_Direction[] = {GPIO_MOTOR_PHI_DIR, GPIO_MOTOR_X_DIR, GPIO_MOTOR_Z_DIR};
#endif